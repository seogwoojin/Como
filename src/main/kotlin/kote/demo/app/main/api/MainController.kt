...
class MainController(
  ...
  fun getMain(model: Model): String {
    model.addAttribute(
        "items", companyService.getCompanyInfoList().sortedByDescending { it.companyClick })
    return "main"
  }
  ...
  fun receiveContact(
    ...
    suggestionRepository.save(Suggestion(name = name, inquiry = inquiry, message = message))
